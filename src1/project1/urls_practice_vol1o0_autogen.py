...
urlpatterns = [
    ...
    path('practice/v1/page-to-be-added-1', PageToBeAdded1.render),

    # O3o3o0g4o1o0 練習ページ ２回追加されたページ
    path('practice/v1/page-to-be-added-2', PageToBeAdded2.render),
    ...
    # O9o1o0g7o1o0 会員一覧
    path('practice/v1/user-list/', UserListV.render),

    # O9o2o0gA12o1o0 （拡張済）会員一覧
    path('practice/v1/extends-user-list/', ExtendsUserListV.render),

    # O9o3o0g7o1o0 アクティブユーザー一覧
    path('practice/v1/active-user-list/', SessionV.render),

    # OA10o2o0g6o1o0 デバッグ用。モデルをダンプ出力
    path('practice/v1/from-object-to-json-str/', DebugV.render_model_as_json),
    ...
    path('practice/v1/vuetify/data-table1', VuetifyV.render_data_table1),

    # OA12o3o0g5o1o0 ビューティファイでバリデーション１
    path('practice/v1/vuetify/validation1', VuetifyV.render_validation1),

    # OA13o1o0g6o1o0 ビューティファイでデザート１
    path('practice/v1/vuetify/desserts1', VuetifyV.render_desserts1),

    # OA13o2o0g7o1o0 ビューティファイでテキストエリア１
    path('practice/v1/vuetify/textarea1', VuetifyV.render_textarea1),

    # OA13o2o0g7o1o0 ビューティファイでデザート１ . テキストエリア１から
    path('practice/v1/vuetify/desserts1-from-textarea1', VuetifyV.render_desserts1_from_textarea1),

    # OA13o3o0g5o1o0 ビューティファイでJSON形式のデザート１
    path('practice/v1/vuetify/desserts1-as-json', VuetifyV.render_desserts1_as_json),

    # OA13o4o0gA13o1o0 ビューティファイでテキストエリア入力から保存まで . 入力
    path('practice/v1/vuetify/textarea1-to-model', VuetifyV.render_textarea1_to_model),

    # OA13o4o0gA13o1o0 ビューティファイでテキストエリア入力から保存まで . 保存
    path('practice/v1/vuetify/save-desserts1-from-textarea1', VuetifyV.render_save_result_of_desserts1_from_textarea1),
