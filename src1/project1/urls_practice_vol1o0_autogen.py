...
urlpatterns = [
    ...
    path('practice/vol1.0/hello-alias/ver1.0/',
         PageTheHello.render, name='practice_vol1o0_hello_alias'),

    # O3o2o0g5o1o0 練習1.0巻 １回追加されたページ1.0版
    ...
    # O8o3o0g5o1o0 練習1.0巻 会員にだけ見えるボタンを説明するページ1.0版
    ...
    path('practice/vol1.0/prefectures/ver1.0/',
         PrefectureV.render_list, name='practice_vol1o0_prefectures'),

    # OA11o2o0g5o1o0 練習1.0巻 都道府県の詳細1.0版
    path('practice/vol1.0/prefectures/read/ver1.0/<int:id>/',
         PrefectureV.render_read, name='practice_vol1o0_prefectures_read'),

    # OA11o3o0g5o1o0 練習1.0巻 都道府県の削除1.0版
    path('practice/vol1.0/prefectures/delete/ver1.0/<int:id>/',
         PrefectureV.render_delete, name='practice_vol1o0_prefectures_delete'),

    # OA11o4o0g6o1o0 練習1.0巻 都道府県の新規作成1.0版
    path('practice/vol1.0/prefectures/create/ver1.0/',
         PrefectureV.render_upsert, name='practice_vol1o0_prefectures_create'),

    # OA11o4o0g6o1o0 練習1.0巻 都道府県の更新1.0版
    path('practice/vol1.0/prefectures/update/ver1.0/<int:id>/',
         PrefectureV.render_upsert, name='practice_vol1o0_refectures_update'),
    ...
    path('practice/vol1.0/vuetify/desserts-from-textarea/ver1.0/',
         VuetifyV.render_desserts1_from_textarea1, name='practice1o0_vuetify_desserts_from_textarea1o0'),
    ...
    path('practice/vol1.0/vuetify/save-desserts-from-textarea/ver1.0/',
         VuetifyV.render_save_result_of_desserts1_from_textarea1, name='practice1o0_vuetify_save_desserts_from_textarea1o0'),

    # OA18o2o0g7o1o0 練習1.0巻 対局部屋の一覧1.0版
    path('practice/vol1.0/rooms/ver1.0/',
         RoomVV1o0.render_list, name='practice_vol1o0_rooms'),

    # OA18o3o0g5o1o0 練習1.0巻 対局部屋の詳細1.0版
    path('practice/vol1.0/rooms/read/ver1.0/<int:id>/',
         RoomVV1o0.render_read, name='practice_vol1o0_rooms_read'),

    # OA18o4o0g5o1o0 練習1.0巻 対局部屋の削除1.0版
    path('practice/vol1.0/rooms/delete/ver1.0/<int:id>/',
         RoomVV1o0.render_delete, name='practice_vol1o0_rooms_delete'),

    # OA18o5o0g6o1o0 練習1.0巻 対局部屋の新規作成1.0版
    path('practice/vol1.0/rooms/upsert/ver1.0/',
         RoomVV1o0.render_upsert, name='practice_vol1o0_rooms_create'),

    # OA18o5o0g6o1o0 練習1.0巻 対局部屋の更新1.0版
    path('practice/vol1.0/rooms/upsert/ver1.0/<int:id>/',
         RoomVV1o0.render_upsert, name='practice_vol1o0_rooms_update'),
    ...
    path('practice/vol1.0/lobby/ver1.0/',
         LobbyV.render_lobby, name='practice_vol1o0_lobby'),

    # OA21o1o0g7o1o0 練習1.0巻 自動リロードページ1.0版
    path('practice/vol1.0/auto-reload/ver1.0/', AutoReloadV.render_auto_reload),

    # OA21o2o0g6o1o0 練習1.0巻 自動リダイレクトページ1.0版
    path('practice/vol1.0/auto-redirect/ver1.0/',
