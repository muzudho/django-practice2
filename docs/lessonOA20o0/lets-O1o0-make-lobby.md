...
# Step O[2 0] 画面作成 - lobby.html ファイル
...
# Step O[3 0] モデルヘルパー モジュール作成 - mh_room フォルダー
...
# Step O[4 0] モデルヘルパー モジュール作成 - mh_get_all_rooms_as_dic.py ファイル
...
# Step O[5 0] ビュー モジュール作成 - lobby フォルダー
...
# Step O[6 0] ビュー モジュール作成 - v_lobby ファイル
