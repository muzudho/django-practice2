...
📖 [この記事のゴール](http://tic.warabenture.com:8000/practice/v1/vuetify/desserts1-as-json)  
...
../src1/project1/urls_practice_vol1o0_autogen.py,practice/v1/vuetify/desserts1-as-json,,"OA13o3o0g5o1o0 ビューティファイでJSON形式のデザート１",apps1.practice_v1.views.vuetifies,VuetifyV,,render_desserts1_as_json
```
