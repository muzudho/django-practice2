...
# Step O3o0 モデルヘルパー モジュール編集 - mh_user フォルダー
...
# Step O4o0 モデルヘルパー モジュール編集 - mh_get_name_by_pk ファイル
...
# Step O5o0 ビュー モジュール作成 - room フォルダー
...
# Step O6o0 ビュー モジュール作成 - v_list ファイル
