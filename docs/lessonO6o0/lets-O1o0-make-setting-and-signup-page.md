...
# Step O[2 0] SMTP設定 - 例えばGoogleアカウント
...
# Step O[4 0] ドッカーコンポーズ編集 - docker-compose.yml ファイル
...
# Step O[5 0] Pythonパッケージ編集 - requirements.txt ファイル
...
# Step O[7 0] 設定編集 - settings.py ファイル
...
# Step O[10 0] テンプレート編集 - signup.html ファイル
...
# Step O[15 0] ポータルページのリンク用データ追加 - finished-lessons.csv ファイル
