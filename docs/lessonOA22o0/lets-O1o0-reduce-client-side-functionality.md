...
📖 [http://localhost:8000/tic-tac-toe/v3o1o0/match-application/](http://localhost:8000/tic-tac-toe/v3o1o0/match-application/)  
...
```csv
/tic-tac-toe/v3o1o0/match-application/,〇×ゲーム v3o1o0 対局申込中
```
