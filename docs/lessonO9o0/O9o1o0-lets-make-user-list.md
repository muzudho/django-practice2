...
# Step O2o0 テンプレート編集 - user-list.html ファイル
...
# Step O3o0 モデルヘルパー モジュール作成 - mh_user フォルダー
...
# Step O4o0 モデルヘルパー モジュール作成 - mh_get_user_dic.py ファイル
...
# Step O5o0 ビュー モジュール作成 - user_list フォルダー
...
# Step O6o0 ビュー モジュール作成 - user_list/v_render.py ファイル
