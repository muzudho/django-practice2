...
# Step O2o0 User モデル拡張 - m_user_profile.py ファイル
...
# Step O3o0 マイグレーション ファイル作成 - コマンド実行
...
# Step O4o0 マイグレーション対象確認 - コマンド実行＜その２＞
...
# Step O6o0 マイグレーション確認 - コマンド実行＜その４＞
...
# Step O7o0 モデルヘルパー編集 - mh_user.py ファイル
...
# Step O8o0 モデルヘルパー モジュール作成 - mh_get_extends_user_dic.py ファイル
...
# Step O9o0 画面編集 - extends_user_list.html ファイル
...
# Step OA10o0 ビュー モジュール作成 - extends_user_list フォルダー
...
# Step OA11o0 ビュー モジュール作成 - extends_user_list/v_render.py ファイル
...
# Step OA12o0 ルート編集 - urls_practice.py ファイル
...
# Step OA13o0 管理画面へモデル登録 - admin.py ファイル編集
...
# Step OA14o0 スーパーユーザーでWebの管理画面へアクセス
