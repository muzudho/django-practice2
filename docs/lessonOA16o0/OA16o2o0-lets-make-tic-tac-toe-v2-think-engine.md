...
# Step O2o0 フォルダー作成 - apps1/tic_tac_toe_v2 フォルダー
...
# Step O6o0 アプリケーション登録 - settings.py ファイル
...
# Step O8o0 概念の定義 - concepts.js ファイル
...
# Step O9o0 局面作成 - position.js ファイル
...
# Step OA10o0 ユーザーコントロール作成 - user_ctrl.js ファイル
...
# Step OA11o0 審判作成 - judge_ctrl.js ファイル
...
# Step OA12o0 思考エンジン作成 - engine.js ファイル
...
# Step OA13o0 エンジン テスト ページ作成 - engine_manual.html ファイル
...
# Step OA14o0 ビュー モジュール作成 - engine_manual フォルダー
...
# Step OA15o0 ビュー モジュール作成 - engine_manual/v_render.py ファイル
...
# Step OA16o0 ルート新規作成 - urls_tic_tac_toe_v2.py ファイル
