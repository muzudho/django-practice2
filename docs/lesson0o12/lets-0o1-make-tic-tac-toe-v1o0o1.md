...
```plaintext
    └── 📂host1
        ...
        │       │       └── 📂v0o1                  # v(1.)0.1 ぐらいの意味。ただのフォルダー。無くてもいい
👉      │       │           └── 📄main.css
        │       ├── 📄__init__.py
        │       ├── 📄admin.py
        │       ├── 📄apps.py
...
# Step 10. 対局申込画面作成 - match_application.html ファイル
...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href='{% static "tic_tac_toe_v1/v0o1/main.css" %}' />
        <!--                                    ============================
                                                1
        1. `host1/apps1/tic_tac_toe/static/tic_tac_toe_v1/v0o1/main.css`
                                           ============================
        -->
    </head>
    <body>
...
# Step 11. 対局画面作成 - playing.html ファイル
...
<html lang="en">
    ...
    <body>
        ...
        <script src="{% static 'tic_tac_toe_v1/v0o1/play.js' %}"></script>
        <!--                    ===========================
                                1
        1. `host1/apps1/tic_tac_toe/static/tic_tac_toe_v1/v0o1/play.js`
                                           ===========================
        -->
...
# Step 13. ルート新規作成 - urls_tic_tac_toe_v1.py ファイル
...
# Step 16. Webソケット用ルート新規作成 - urls_ws1.py ファイル
...
# Step 17. Djangoの設定 - settings.py ファイル
