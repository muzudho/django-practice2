...
class MhRoom():
    ...
    #    ------------------------        --------------------
    #    1                               2
    # 1. `host1/apps1/practice/model_helper/mh_room/mh_get_all_rooms_as_dic.py`
    #                                               -----------------------
    # 2. `1.` に含まれる関数
```
...
# Step 6. ビュー モジュール作成 - v_upsert ファイル
...
📖 [http://localhost:8000/practice/lobby/](http://localhost:8000/practice/lobby/)  
